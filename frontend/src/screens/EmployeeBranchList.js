...
class Employeebranchlist extends Component {
    constructor(props) {
        super(props)
    ...
    back(){
        this.props.history.push('/EmployeeBoard');
    }
        ...
        return (
            <div>
                 ...
                 <div className = "row">
                    ...
                    <button className="btn btn-success btn-lg"style={{marginBottom: "10px", width:"250px"}} onClick={this.back.bind(this)}> back to Employee board</button>
                 </div>
                 <br></br>
                 <div className = "row">
